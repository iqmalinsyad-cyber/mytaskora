...
export const INITIAL_ADUAN_CASES: AduanCase[] = [
  {
    ...
    alamat: 'Kompleks Kediaman Seri Perdana, Blok B, Presint 8, 62250 Putrajaya',
    sumberAduan: 'Aduan Awam',
    catatanKes: 'Lif nombor 2 sering terhenti secara tiba-tiba di antara tingkat 4 dan 5. Kejadian telah berlaku 3 kali minggu ini dan mendedahkan warga emas kepada bahaya.',
    status: 'Dalam Siasatan',
    gambarSiasatan: [
      {
        id: 'img-1',
        url: 'https://images.unsplash.com/photo-1577495508048-b635879837f1?auto=format&fit=crop&q=80&w=800',
        name: 'Kerosakan Pintu Lif Blok B',
        capturedAt: '2026-08-04T10:00:00Z',
      }
    ],
    tindakan: 'Telah Diproses',
    syorBantuan: 'Ada',
  ...
  },
  {
    ...
    alamat: 'No. 45, Jalan Anggerik 2/1, Seksyen 2, 40000 Shah Alam',
    sumberAduan: 'CMU',
    catatanKes: 'Sistem e-Lesen mengalami terputus sambungan semasa proses pembayaran bayaran tahunan, menyebabkan resit tidak dapat dijana.',
  ...
  },
  {
    ...
    alamat: 'Wisma Bandar Utama, Tingkat 12, 47800 Petaling Jaya',
    sumberAduan: 'HQ',
    catatanKes: 'Permohonan permit bernombor PRM-9921 telah diproses dan diserahkan kepada pemohon selepas semakan selesai.',
    status: 'Selesai',
    gambarSiasatan: [],
    tindakan: 'Telah Diproses',
    syorBantuan: 'Ada',
  ...
  },
  {
    ...
    alamat: 'Persimpangan Jalan Melati 3, Taman Bunga Raya, 43000 Kajang',
    sumberAduan: 'Parlimen',
    catatanKes: 'Dahan pokok besar di persimpangan jalan melintas garisan tiang elektrik voltan tinggi. Berisiko litar pintas semasa hujan lebat.',
  ...
  },
  {
    ...
    alamat: 'No. 88, Jalan SS 15/4, 47500 Subang Jaya',
    sumberAduan: 'Adun',
    catatanKes: 'Penyelarasan nombor akaun baharu ACC-88291 telah disempurnakan dan disahkan.',
    status: 'Selesai',
    gambarSiasatan: [],
    tindakan: 'Telah Diproses',
    syorBantuan: 'Tiada',
  ...
  },
  {
    ...
    alamat: 'Blok C-3-12, Kondominium Impian, 68000 Ampang',
    sumberAduan: 'MAIS',
    catatanKes: 'Semakan rekod caj invois bertindih telah diserahkan kepada unit kewangan untuk semakan bayaran balik.',
    status: 'Dalam Siasatan',
    gambarSiasatan: [],
    tindakan: 'KIV',
    syorBantuan: 'Ada',
