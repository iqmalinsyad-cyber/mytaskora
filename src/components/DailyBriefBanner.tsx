        ...
        <div className="relative z-10 space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-2.5 pt-2">
            <button
              ...
              className="px-4 py-2 rounded-lg bg-white text-indigo-600 text-xs font-bold hover:bg-indigo-50 transition-all shadow-xs flex items-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white text-xs font-semibold backdrop-blur-md transition-all border border-white/20 flex items-center gap-1.5 cursor-pointer"
            >
